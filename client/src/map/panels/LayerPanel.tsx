...
/**
 * Raster overlay switchboard.
 *
 * Renders whatever RASTER_LAYERS contains, so a new overlay needs no change
  ...
  return (
    <Card className="pointer-events-auto absolute top-20 left-3 z-10 w-72 border-border/60 bg-background/85 shadow-lg backdrop-blur-md">
      <CardHeader>
        ...
        <CardDescription>Raster overlays drawn above the basemap.</CardDescription>
      </CardHeader>
      <CardContent>
